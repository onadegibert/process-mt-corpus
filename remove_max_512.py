...
# This file is used to removes sentences longer than 512 tokens on tokenized parallel corpora
...
def filter(src, tgt):
    ...
    indeces_to_remove = []
    for line in src:
        if len(line.split()) > 512: #if a line is longer than 512
...
# Removed 26 lines for train.ca-oc.ca
# Removed 81 lines for train.ca-ro.ca
# Removed 113 lines for train.ca-it.ca